...
int main(int argc, const char * argv[]) {
    ...
    for(int z=0; z<nMu; z++)
    {
       ...
       for(int j=0; j<nK; j++)
       {
           ...
           double kernel1_xy = dE1_k_dkx*dE1_k_dkx*ddE1_k_dky_dky - dE1_k_dkx*dE1_k_dky*ddE1_k_dkx_dky;
           
           double kernel2_xx = dE2_k_dkx*dE2_k_dkx;
           double kernel2_xy = dE2_k_dkx*dE2_k_dkx*ddE2_k_dky_dky - dE2_k_dkx*dE2_k_dky*ddE2_k_dkx_dky;
       ...
       fprintf(fileOut,"% 4.8e % 4.8e % 4.8e % 4.8e ", f*sigma1_xx, f*sigma2_xx, -f*sigma1_xy*2./3., -f*sigma2_xy*2./3.);
       fprintf(fileOut,"% 4.8e % 4.8e % 4.8e % 4.8e ", f*alpha1_xx, f*alpha2_xx, -f*alpha1_xy*2./3., -f*alpha2_xy*2./3.);
       fprintf(fileOut,"% 4.8e % 4.8e % 4.8e % 4.8e ", f*beta1_xx,  f*beta2_xx,  -f*beta1_xy*2./3.,  -f*beta2_xy*2./3.);
       fprintf(fileOut,"\n");
    }
    fclose(fileOut);
